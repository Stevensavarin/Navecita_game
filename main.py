...
asset_sound = resource_path("assets/sound/naruto.mp3")
background_sound = pygame.mixer.music.load(asset_sound)

asset_playering = resource_path("assets/img/space-invaders.png")
playering = pygame.image.load(asset_playering)

asset_bulleting = resource_path("assets/img/bullet.png")
bulleting = pygame.image.load(asset_bulleting)

asset_over_font = resource_path("assets/font/RAVIE.TTF")
over_font = pygame.font.Font(asset_over_font, 60)

asset_font = resource_path("assets/font/comicbd.ttf")
